...
/// <summary>
/// Defends friendly capture points
/// </summary>
public class BotDefender : MonoBehaviour
{
    [Header("Settings")]
    public float checkInterval = 3f;
    public float defenseRange = 15f;
    ...
    void MoveToTarget()
    {
        if (targetFlag != null && navMeshMovement != null)
        {
            ...
            {
                // Patrol perimeter
                Vector2 offset = Random.insideUnitCircle.normalized * defenseRange * 0.8f;
    ...
    void FindTargetFlag()
    {
        ...
        // First try to find friendly flags to defend
        ...
        // If no friendly flags, attack neutral flags instead
        if (bestFlag == null)
        {
            foreach (var flag in flags)
            {
